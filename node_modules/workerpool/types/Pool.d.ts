 ...
 * @constructor
 */
declare function Pool(script?: string | undefined, options?: import("workerpool/types/types").WorkerPoolOptions | undefined): void;
declare class Pool {
    /**
     * A pool to manage workers, which can be created using the function workerpool.pool.
     *
     ...
     * @constructor
     */
    constructor(script?: string | undefined, options?: import("workerpool/types/types").WorkerPoolOptions | undefined);
    /** @readonly */
    ...
    /** @readonly */
    readonly onCreateWorker: ((arg: import("workerpool/types/types").WorkerArg) => import("workerpool/types/types").WorkerArg | undefined) | (() => null);
    /** @readonly */
    readonly onTerminateWorker: (arg: import("workerpool/types/types").WorkerArg) => void;
    /** @readonly */
     ...
     */
    exec<T extends (...args: any[]) => any>(method: string | T, params?: Parameters<T> | null | undefined, options?: import("workerpool/types/types").ExecOptions | undefined): Promise<ReturnType<T>>;
    /**
    ...
    }>(...args: any[]): Promise<import("workerpool/types/types").Proxy<T>, Error>;
    private _next;
    private _getWorker;
...
import { Promise } from "workerpool/types/Promise";
