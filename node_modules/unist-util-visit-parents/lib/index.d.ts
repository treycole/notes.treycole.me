export function visitParents<
  Tree extends import('unist-util-visit-parents/node_modules/@types/unist').Node,
  Check extends Test
>(
  tree: Tree,
  check: Check,
...
export type UnistNode = import('unist-util-visit-parents/node_modules/@types/unist').Node
export type UnistParent = import('unist-util-visit-parents/node_modules/@types/unist').Parent
/**
...
export type InternalParent<
  Node extends import('unist-util-visit-parents/node_modules/@types/unist').Node,
  Child extends import('unist-util-visit-parents/node_modules/@types/unist').Node
> = Node extends import('unist-util-visit-parents/node_modules/@types/unist').Parent
  ? Node extends {
 ...
 */
export type Visitor<
  Visited extends import('unist-util-visit-parents/node_modules/@types/unist').Node = import('unist-util-visit-parents/node_modules/@types/unist').Node,
  VisitedParents extends import('unist-util-visit-parents/node_modules/@types/unist').Parent = import('unist-util-visit-parents/node_modules/@types/unist').Parent
...
export type BuildVisitor<
  Tree extends import('unist-util-visit-parents/node_modules/@types/unist').Node = import('unist-util-visit-parents/node_modules/@types/unist').Node,
