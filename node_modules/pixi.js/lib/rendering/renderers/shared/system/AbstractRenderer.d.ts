...
import { EventEmitter } from 'pixi.js/lib/utils/utils';
import { SystemRunner } from 'pixi.js/lib/rendering/renderers/shared/system/SystemRunner';
import type { ColorSource } from 'pixi.js/lib/color/Color';
import type { ICanvas } from 'pixi.js/lib/environment/canvas/ICanvas';
import type { Matrix } from 'pixi.js/lib/maths/matrix/Matrix';
import type { Rectangle } from 'pixi.js/lib/maths/shapes/Rectangle';
import type { TypeOrBool } from 'pixi.js/lib/scene/container/destroyTypes';
import type { CLEAR_OR_BOOL } from 'pixi.js/lib/rendering/renderers/gl/const';
import type { BackgroundSystem } from 'pixi.js/lib/rendering/renderers/shared/background/BackgroundSystem';
import type { GenerateTextureOptions, GenerateTextureSystem } from 'pixi.js/lib/rendering/renderers/shared/extract/GenerateTextureSystem';
import type { PipeConstructor } from 'pixi.js/lib/rendering/renderers/shared/instructions/RenderPipe';
import type { RenderSurface } from 'pixi.js/lib/rendering/renderers/shared/renderTarget/RenderTargetSystem';
import type { Texture } from 'pixi.js/lib/rendering/renderers/shared/texture/Texture';
import type { ViewSystem, ViewSystemDestroyOptions } from 'pixi.js/lib/rendering/renderers/shared/view/ViewSystem';
import type { SharedRendererOptions } from 'pixi.js/lib/rendering/renderers/shared/system/SharedSystems';
import type { SystemConstructor } from 'pixi.js/lib/rendering/renderers/shared/system/System';
