...
import { EmulatedRegExp } from 'oniguruma-to-es/types/subclass.js';
/**
@typedef {{
...
export function toDetails(pattern: string, options?: OnigurumaToEsOptions): {
    pattern: string;
    flags: string;
    options?: import("oniguruma-to-es/types/subclass.js").EmulatedRegExpOptions;
};
/**
...
}): import("oniguruma-to-es/types/parse.js").OnigurumaAst;
/**
