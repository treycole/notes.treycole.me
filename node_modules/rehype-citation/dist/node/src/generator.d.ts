...
export type CiteItem = import('rehype-citation/node/dist/node/src/types.js').CiteItem;
export type Mode = import('rehype-citation/node/dist/node/src/types.js').Mode;
export type Options = import('rehype-citation/node/dist/node/src/types.js').Options;
/**
